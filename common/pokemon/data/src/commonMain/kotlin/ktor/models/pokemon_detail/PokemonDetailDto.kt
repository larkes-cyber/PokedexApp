package ktor.models.pokemon_detail

import kotlinx.serialization.SerialName
import kotlinx.serialization.Serializable


@Serializable data class PokemonDetailDto(
...
@Serializable data class MoveLearnMethod(
...
@Serializable data class PastTypesItem(
...
@Serializable data class VersionGroupDetailsItem(
...
@Serializable data class GenerationIv(
...
@Serializable data class GenerationI(
...
@Serializable data class RedBlue(
...
@Serializable data class RubySapphire(
...
@Serializable data class FormsItem(
...
@Serializable data class MovesItem(
...
@Serializable data class Generation(
...
@Serializable data class GenerationV(

	@SerialName("black-white")
	val blackWhite: BlackWhite? = null
)

@Serializable data class HeldItemsItem(
...
@Serializable data class GenerationIi(
...
@Serializable data class Crystal(
...
@Serializable data class DiamondPearl(
...
@Serializable data class FireredLeafgreen(
...
@Serializable data class OmegarubyAlphasapphire(
...
@Serializable data class Platinum(
...
@Serializable data class Emerald(
...
@Serializable data class Animated(
...
@Serializable data class GenerationVi(
...
@Serializable data class VersionDetailsItem(
...
@Serializable data class Silver(
...
@Serializable data class TypesItem(
...
@Serializable data class StatsItem(
...
@Serializable data class HeartgoldSoulsilver(
...
@Serializable data class UltraSunUltraMoon(
...
@Serializable data class AbilitiesItem(
...
@Serializable data class GameIndicesItem(
...
@Serializable data class Yellow(
...
@Serializable data class Showdown(
...
@Serializable data class Species(
...
@Serializable data class DreamWorld(

	@SerialName("front_default")
	val frontDefault: String? = null,
)

@Serializable data class GenerationViii(
...
@Serializable data class GenerationIii(
...
@Serializable data class GenerationVii(
...
@Serializable data class VersionGroup(
...
@Serializable data class BlackWhite(
